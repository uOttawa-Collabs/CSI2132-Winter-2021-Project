...
public class EmployeeService {
	private 	   String     url = "jdbc:postgresql://web0.site.uottawa.ca:15432/group_a02_g01";
	private 	   String 	  user = ""; //Need add username when compile
	private 	   String 	  password = ""; //Need add password when compile
	...
	public Employment accessEmployment(int employeeId)
	{
		...
		try
		{
			...
			else
			{
				...
				{
					employment = new Employment(rsEmployment.getString("hotel_brand_name"), rsEmployment.getString("hotel_name"), employeeId);
				}
	...
	{
		List<Book> bookedRooms = new ArrayList<Book>();
	...
	public static void main(String args[]) {
		...
		while(!EmployeeIdCheck)
		{
			...
			if(employment != null)
			{
				...
				System.out.println("Employee " + employeeId + " only has permission to access and operate service in " + hotelName + " (" + hotelBrandName + ")");
				System.out.println();
		...
		{	
			while(!serviceChooseCheck)
			{
				...
				if(num.equals("1"))
				{
					...
					{
						System.out.println("Customer " + customerID + " doesn't have booking history, please enter more information to finish check-in service.");
						...
						System.out.println("There are/is " + numOfRooms + " room(s) are available in " + hotelName + " (" + hotelBrandName + ")");
						...
						for(int i=0; i<availableRooms.size(); i++)
						{
							...
							System.out.println("Room ID: " + roomId + "; Price: " + price + "; Room capacity: " + room.getRoomCapacity());
						}
						...
						boolean checkIn = employeeService.checkInWithoutBooking(customerID, roomID, employeeID, date, roomType, totalNumberOccupants, days);
				...
				else if(num.equals("3"))
				{
					...
					String numOfRooms = String.valueOf(availableRooms.size());
					System.out.println("There are " + numOfRooms + " rooms are available in " + hotelName + " (" + hotelBrandName + ")"); 
				...
				else if(num.equals("4"))
				{
					...
					System.out.println("There are " + numOfRooms + " rooms are booked in " + hotelName + " (" + hotelBrandName + ")"); 
					...
					for(int i=0; i<bookedRooms.size(); i++)
					{
						...
						System.out.println("Room ID: " + roomId + "; Customer ID: " + customerId + "; Check-in Date： " + checkInDate 
											+ "; Room Type: " + bookRoom.getRoomType() + "; Total number of occupants: " + totalNumberOccupants);
